...
namespace Managers
{
    public class SwapManager : MonoBehaviour
    {
        ...
        private void SwapElements(GameObject element1, GameObject element2)
        {
            ...
            sequence.Append(element1.transform.DOMove(element2.transform.position, 0.2f))
                .SetEase(Ease.Flash).Join(element2.transform.DOMove(element1.transform.position, 0.2f))
